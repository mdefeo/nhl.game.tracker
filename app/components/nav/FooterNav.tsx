...
const FooterNav: React.FC<Props> = ({ }) => {
  ...
  <footer className="footer p-10 mt-10 bg-base-300 text-base-content">
    <nav>
      <h6 className="footer-title">Stats</h6> 
      <Link 
        href="/players" 
    ...
    <nav>
      ...
      <Link 
        href="https://github.com/mdefeo/nhl.game.tracker" 
        className="link link-hover" 
        target="_blank" 
        rel="noopener noreferrer"
      >
    ...
    <nav>
      ...
      <Link 
        href="https://www.reddit.com/user/thelastmeritocracy/" 
        target="_blank" 
        rel="noopener noreferrer"
      >
        <span className="[&>svg]:h-5 [&>svg]:w-5">
      ...
      <Link 
        href="https://twitter.com/lastmeritocracy" 
        target="_blank" 
        rel="noopener noreferrer"
      >
        <span className="[&>svg]:h-5 [&>svg]:w-5">
